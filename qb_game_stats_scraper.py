    ...
    if response.status_code == 200:
        ...
        if season_stats_table:
            ...
            for row in season_stats_table.find_all('tr')[1:]:
                ...
                data.append([year, week, opponent, result, snap_count, snap_percent, pass_comp, pass_att, pass_yards, pass_tds, 
...
def export_to_csv(data, filename, output_folder):
    if data:
        ...
        with open(filepath, 'a', newline='') as csvfile:
            ...
            if is_file_empty:
                writer.writerow(['player_id', 'player_name', 'player_url', 'position', 'year', 'week', 'opponent', 'result', 'snap_count', 'snap_percent', 'pass_comp', 'pass_att', 
...
if __name__ == "__main__":
    ...
    output_filename = "qb_game_stats.csv"
