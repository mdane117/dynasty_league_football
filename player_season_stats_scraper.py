    ...
    if response.status_code == 200:
        ...
        if season_stats_table:
            ...
            for row in season_stats_table.find_all('tr')[1:]:
                ...
                data.append([year, team, games_played, snap_count, snap_percent, rush_att, rush_yards, rush_tds, targets, 
...
def export_to_csv(data, filename, output_folder):
    if data:
        ...
        with open(filepath, 'a', newline='') as csvfile:
            ...
            if is_file_empty:
                writer.writerow(['player_id', 'player_name', 'player_url', 'position', 'year', 'team', 'games_played', 'snap_count', 'snap_percent', 'rush_att', 'rush_yards', 
...
if __name__ == "__main__":
    input_filename = "" # Add filepath to input file ff_rankings.csv
    output_folder = "" # Add filepath to output folder
    output_filename = "player_season_stats.csv"
